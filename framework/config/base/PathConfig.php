...
final class PathConfig
{
    ...
    public static function GetConfig(array $custom_config) : array
    {
        ...
        $template_lib                       = $custom_config['general']['template_library'];        
        ...
        $def_config['fw_folder_url']        = $def_config['web_domain'] . $rel_path;        
        ...
        $def_config['fw_template_folder']   = "vendors" . $sep . $template_lib . $sep . "html";
        ...
        $def_config['app_template_folder']  = $def_config['ui_folder'] . $sep . "html";
  		...
  		/** The url to the user interface folder */
        $def_config['ui_folder_url']        = $def_config['app_folder_url'] . "/" . $def_config['ui_folder'];
